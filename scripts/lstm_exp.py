...
should get this to work based on 3d tensor instead of 2d since it's dealing
with sequences
however, what I'm not sure is to make it as a sequence of 1 or sequence of
total size of data
    ...
    for n_layers in xrange(1, num_layers + 1):
        for n_neurons in xrange(start_neurons, num_neurons + 5, 5):
            for method in methods:
                ...
                h_to_o = nc.setup_ff_network(
                    n_neurons, out_dim, n_layers - 1, n_neurons)
                ...
                cost = ds.get_cost_data(
                    test_monitor, train_set.num_examples, num_epochs)
